...
export const SkillsSection = () => {
    ...
    const filteredSkills = skills.filter((skill) => activeCategory === "all" || skill.categore === activeCategory);
     ...
     <div className="container mx-auto max-w-5xl">
       ...
       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
         {filteredSkills.map((skill, key) => (
            ...
            <div className="bg-primary h-2 rounded-full origin-lef animate-[grow_1.5s_ease-out" style={{width: skill.level + "%" }}/>
            </div>
